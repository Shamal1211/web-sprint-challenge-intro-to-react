...
React is a UX/UI library created by facebook to solve complex state webpages. 

2. Describe component state.
Component states are when they change. The component is then re-rendered. 
3. Describe props.
Props transfer data between components. They have a parent and child relationship. 
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side Effects are something that effects something outside the scope of a function. You set them with React components. 
